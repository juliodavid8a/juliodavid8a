...
[![Claude](https://img.shields.io/badge/-Claude_Code-D4A574?style=flat-square&logo=anthropic&logoColor=white)](https://claude.ai/)
...
```mermaid
flowchart LR
    F["🗓️ Flow\nplan & schedule"] --> CC["⚡ CC-Runner\nwrite code"]
    CC --> SL["🧪 Ship Lab\nvalidate quality"]
    CC --> Products["📦 Products"]
    SL -.->|feedback| CC
    W["🧠 Wiki\ncapture knowledge"] -.->|informs| F
    CC --> W
```
